...
export const COMPONENTS = {
  ...
  ring: {
    label: 'comp.ring',
    defaults: () => ({ type: 'ring', color: '#38BDF8', min: 0, max: 100, cap_font: 14 }),
    ...
    compFields: [['color', 'field.color', 'color'],
                 ...
                 ['cap_font', 'field.cap_font', 'font', c => !!(c.countdown || c.cap_prefix)],
                 ['cap_family', 'field.cap_family', 'fontfamily', c => !!(c.countdown || c.cap_prefix)],
                 ['cap_bold', 'field.cap_bold', 'bool', c => !!(c.countdown || c.cap_prefix)],
                 ['cap_italic', 'field.cap_italic', 'bool', c => !!(c.countdown || c.cap_prefix)],
                 ['bind', 'field.bind', 'idtext']],

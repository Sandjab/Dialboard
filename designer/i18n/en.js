...
export default {
  ...
  // --- Inspecteur : composant « state » (mode de correspondance + cas + visuel piloté par la valeur) ---
  ...
  'iconpicker.search': 'Search an icon…',
  'iconpicker.all_cats': 'All categories',
  'iconpicker.none': 'No matching icon',
  'scenepicker.title': 'Choose a scene',
  'scene.sunny': 'Sunny',
  'scene.rain': 'Rain',
  'scene.snow': 'Snow',
  'scene.storm': 'Storm',
  'scene.wind': 'Wind',
  'scene.spinner': 'Loading',
  'scene.alert': 'Alert',
  'scene.bell': 'Bell',
  'scene.pulse': 'Pulse',

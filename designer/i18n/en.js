...
export default {
  ...
  'inspector.note.doc_counts': '{np} page(s) · {nc} component(s)',
  ...
  'inspector.link.device': 'Open the plumbing (Device) →',
  'inspector.link.device_tip': 'Physical outputs (led_ring/sound) + pull sources',
